...
public class Controller {
    ...
    private static void secondreviveClickMet(Clicking click, Location btnloc) {
        ...
        if (model.exsitInGetPosiblePlace(clickedLocation, btnloc)) {
            ...
            System.out.println("---------is END Game-----------------");
            System.out.println(turn.getTurnName() + ":" + model.getSoldiersNoFinishers(turn).size() + "\n" + NOturn.getTurnName() + ":" + model.getSoldiersNoFinishers(NOturn).size());
