...
public class Move 
{
    ...
    {
        return "Move{" + "Blackconter=" + Blackconter + ", whiteconter=" + whiteconter + ", blackCaptives=" + blackCaptives + ", whiteCaptives=" + whiteCaptives + ", Now=" + Now + ", ToGo=" + ToGo + ", turn=" + turn + ", Noturn=" + Noturn + ", move=" + move + '}';
    }
